...
/**
 * This is the item provider adapter for a {@link sqlProgram.Clause} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClauseItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Clause_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Clause_name_feature", "_UI_Clause_type"),
						SqlProgramPackage.Literals.CLAUSE__NAME, true, false, false,
	...
	protected void addBodyPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Clause_body_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Clause_body_feature", "_UI_Clause_type"),
						SqlProgramPackage.Literals.CLAUSE__BODY, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Clause_type")
	...
	public void notifyChanged(Notification notification) {
		...
		case SqlProgramPackage.CLAUSE__NAME:
		case SqlProgramPackage.CLAUSE__BODY:
